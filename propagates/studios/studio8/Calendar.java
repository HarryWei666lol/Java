...
public class Calendar {
	...
	public Calendar(Set<Appointment> calendar) {
		this.calendar = calendar;
	}

	public boolean doesExist(Appointment apt) {
		return this.calendar.contains(apt);
	}
	
	public boolean addApt(Appointment apt) {
	...
	public static void main(String[] args) {
		...
		HashSet<Appointment> set1 = new HashSet<Appointment>();
		set1.add(apt1);
		set1.add(apt2);
